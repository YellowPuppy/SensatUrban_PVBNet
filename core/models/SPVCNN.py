...
from core.modules.utils import initial_voxelize, point_to_voxel, voxel_to_point
...
class SPVCNN(nn.Module):
    ...
    def forward(self, x):
        ...
        z = PointTensor(x.F, x.C.float()) # 这里取了float
...
if __name__ == '__main__':
    model = SPVCNN(num_classes=19,
                   cr=1.0,
                   pres=0.05,
                   vres=0.05)
    # print(model)
    pc = torch.IntTensor(1000, 6)
    feat = torch.FloatTensor(1000, 6)
